---
title: Introduction
description: MDC Syntax is a powerful Markdown parser that extends standard Markdown with component syntax, enabling rich, interactive content in Vue and React applications.
---
